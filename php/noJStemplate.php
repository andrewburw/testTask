...
if(isset($_POST['email'])){
    ...
    $result = validateInput($email,$cbox); // file separate_functions.php
    $submitedForm = true;

     if($result['validEmail'] === false &&  $result['validCheckbox'] === false){

     $submit = true;

     $resultPostData =  $db->postDataPHP($email);

   }
    if (  $submitedForm === true && $result['validEmail'] === true){

     $buttoncss = 'is-invalid-button';
     $inputcss = 'is-invalid';
     $inputErrorMsg  =   '<small class="invalid-feedback">'.$result['emailMsg'].'</small>';


   }
   if (  $submitedForm === true && $result['validCheckbox'] === true){

    $checkboxcss = 'is-invalid-checkbox';
    $checkboxErrorMs  =   '<small class="invalid-feedback">'.$result['checkMsg'].'</small>';
  ...
  if($submit){
          ...
          <object type="image/svg+xml" data="images/ic_success.svg"> Your browser does not support SVG</object>
             ...
             <div class="test">
              ...
              <div class="social__icons-container">
                <ul>
                  <li class="social__icons-item"><a href="#">
                      <svg width="46" height="46" viewBox="0 0 46 46" class="facebook" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="23" cy="23" r="22" class="defaultCircle " stroke-width="2" />
                        <path class="defaultLogo"
                  ...
                  <li class="social__icons-item"><a href="#">
                      <svg width="46" height="46" viewBox="0 0 46 46" class="instagram" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="23" cy="23" r="22" class="defaultCircle " stroke-width="2" />
                        <path class="defaultLogo"
                  ...
                  <li class="social__icons-item"><a href="#">
                      <svg width="46" height="46" viewBox="0 0 46 46" class="twitter" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="23" cy="23" r="22" class="defaultCircle " stroke-width="2" />
                        <path class="defaultLogo"
                  ...
                  <li class="social__icons-item"><a href="#">
                      <svg width="46" height="46" viewBox="0 0 46 46" class="youtube" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="23" cy="23" r="22" class="defaultCircle " stroke-width="2" />
                        <path class="defaultLogo"
     ...
     ?>
     <main class="form__field">
       <div class="main__container-responsive">
       <div class="wecome__msg">


         <h1>Subscribe to newsletter</h1>
         <p class="form__field-p">Subscribe to our newsletter and get 10% discount on pineapple glasses.</p>
       </div>
     <div class="form__input-container">
       <form action="index.php" method="post">
         <div class="inputGrup">
           <div class="input__plus-button">
             <input type="email" class="<? echo $inputcss;  ?>" name="email" value="<?= isset($_POST['email']) ? $_POST['email'] : ''; ?>"  placeholder="Type your email address here…" required/>
             <button type="submit"  class="<?  echo   $buttoncss;  ?>"><img src="../images/ic_arrow.png"></button>
            </div>
              <?  echo   $inputErrorMsg;  ?>
         </div>
         ...
         <div class="checkbox__container">
           <div class="round ">
             ...
             <label class="<? echo $checkboxcss;  ?>" for="checkbox"></label>
             <div class="chebox__lable">I agree to <a href="#">terms of service</a></div>
           </div>
            <?  echo   $checkboxErrorMs;  ?>
         </div>
       </form>
     </div>
    <div class="test">
